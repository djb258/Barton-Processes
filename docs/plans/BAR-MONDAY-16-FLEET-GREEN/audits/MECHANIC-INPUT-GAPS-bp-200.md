# MECHANIC-INPUT-GAPS — bp.200 People Worker
**BAR:** BAR-MONDAY-16-FLEET-GREEN
**Audited:** 2026-05-08
**Auditor:** Sonnet (read-only baseline)
**Process path:** `factory/outreach/200-people-worker/`
...
| §9b ≥1 real value (no TBD/TBV-only) | G06 | PASS | 9 live rows with real values present |
...
### GAP-200-01 — G03: `services` missing from outside.heir
- **Fault:** `services` field absent from the outside.heir frontmatter block in PROCESS-UT.md
- **Fix:** Add `services: [people-worker, cloudflare-d1, lbb, mission-control]` (verify against wrangler.toml) to outside.heir
- **Scope:** PROCESS-UT.md outside.heir block

### GAP-200-02 — G08: §14 SESSION LOG wrong columns
...
G01, G02, G04, G05, G06, G07, G09, G10, G12 — all PASS, no touch.
