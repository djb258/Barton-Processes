# MECHANIC-INPUT-GAPS — bp.500 Talent Flow
**BAR:** BAR-MONDAY-16-FLEET-GREEN
**Audited:** 2026-05-08
**Auditor:** Sonnet (read-only baseline)
**Process path:** `factory/outreach/500-talent-flow/`
...
| §9b ≥1 real value (no TBD/TBV-only) | G06 | FAIL | All §9b rows are TBV — no live verification performed |
...
### GAP-500-01 — G03: `services` missing from outside.heir
- **Fault:** `services` field absent from the outside.heir frontmatter block in PROCESS-UT.md
- **Fix:** Add `services: [talent-flow, cloudflare-d1, lbb, mission-control]` (verify against wrangler.toml) to outside.heir
- **Scope:** PROCESS-UT.md outside.heir block

### GAP-500-02 — G06: §9b all-TBV
- **Fault:** All §9b live verification rows have TBV in the Value column — live verification has not been performed
...
### GAP-500-03 — G08: §14 SESSION LOG wrong columns
