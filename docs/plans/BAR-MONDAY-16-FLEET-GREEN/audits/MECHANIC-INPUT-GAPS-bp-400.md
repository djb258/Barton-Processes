# MECHANIC-INPUT-GAPS — bp.400 DOL Views
**BAR:** BAR-MONDAY-16-FLEET-GREEN
**Audited:** 2026-05-08
**Auditor:** Sonnet (read-only baseline)
**Process path:** `factory/outreach/400-dol-views/`
...
| §9b ≥1 real value (no TBD/TBV-only) | G06 | PASS | 2 rows with real values present |
...
### GAP-400-01 — G03: `services` missing from outside.heir
- **Fault:** `services` field absent from the outside.heir frontmatter block in PROCESS-UT.md
- **Fix:** Add `services: [dol-views, cloudflare-d1, lbb, mission-control]` (verify against wrangler.toml) to outside.heir
- **Scope:** PROCESS-UT.md outside.heir block

### GAP-400-02 — G08: §14 SESSION LOG wrong columns
