# MECHANIC-INPUT-GAPS — bp.700 Campaign Engine
**BAR:** BAR-MONDAY-16-FLEET-GREEN
**Audited:** 2026-05-08
**Auditor:** Sonnet (read-only baseline)
**Process path:** `factory/outreach/700-campaign-engine/`
...
### GAP-700-01 — G03: `services` missing from outside.heir
- **Fault:** `services` field absent from the outside.heir frontmatter block in PROCESS-UT.md
- **Fix:** Add `services: [campaign-engine, cloudflare-d1, lbb, mission-control]` (verify against wrangler.toml) to outside.heir
- **Scope:** PROCESS-UT.md outside.heir block

### GAP-700-02 — G06: §9b all-TBV
...
### GAP-700-03 — G08: §14 SESSION LOG wrong columns
