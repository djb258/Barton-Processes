# MECHANIC-INPUT-GAPS — bp.820 Vendor Export
**BAR:** BAR-MONDAY-16-FLEET-GREEN
**Audited:** 2026-05-08
**Auditor:** Sonnet (read-only baseline)
**Process path:** `factory/client/820-vendor-export/`
...
| §9b ≥1 real value (no TBD/TBV-only) | G06 | PASS | Rows 2, 3, 5, 6, 8 have real 2026-05-04 values |
...
### GAP-820-01 — G08: §14 SESSION LOG wrong columns
...
**Note:** bp.820 ties bp.202 as the cleanest process in the fleet — single gap (systemic G08 only). G03 and G06 are both fully compliant.
