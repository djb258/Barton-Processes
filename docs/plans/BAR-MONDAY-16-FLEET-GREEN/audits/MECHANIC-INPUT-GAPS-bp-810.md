# MECHANIC-INPUT-GAPS — bp.810 Client Intake
**BAR:** BAR-MONDAY-16-FLEET-GREEN
**Audited:** 2026-05-08
**Auditor:** Sonnet (read-only baseline)
**Process path:** `factory/client/810-client-intake/`
...
### GAP-810-01 — G03: `services` and `subject_id` missing from outside.heir
...
- **Fix (a):** Add `services: [client-intake, cloudflare-d1, lbb, mission-control]` (verify against wrangler.toml) to outside.heir
- **Fix (b):** Add `subject_id: svg-client-proc` to outside.heir
- **Scope:** PROCESS-UT.md outside.heir block

### GAP-810-02 — G06: §9b all-TBV
...
### GAP-810-03 — G08: §14 SESSION LOG wrong columns
