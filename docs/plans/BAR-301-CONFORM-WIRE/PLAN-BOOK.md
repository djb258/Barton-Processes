...
outside:
  heir:
    sovereign_ref: barton-processes
    hub_id: bar-301-conform-wire
    ctb_placement: leaf
    ctb_node: barton-enterprises/svg-agency/outreach/301-page-parser/bars/conform-wire
    imo_topology: hub
    cc_layer: CC-01
...
inside:
  heir:
    process_id: bar.301-conform-wire
    species: Plan-Body
    version: "1.0.0"
    last_modified: "2026-05-06"
    companion_manifest: docs/plans/BAR-301-CONFORM-WIRE/PLAN-BOOK.md
  orbt:
    library_state: BUILD
---

# PLAN BOOK — BAR-301-CONFORM-WIRE

## §1 Purpose

Bring `factory/outreach/301-page-parser/` to Atlas/BS Law Y-junction conformance and
wire its paired Library Books (PROCESS-UT.md + workflow.yaml) into Mission Control
via the `system.processes` shelf slot.

Process: **Page Parser** (PROC-301)
...
mission_control_wiring:
  - artifact: factory/outreach/301-page-parser/PROCESS-UT.md
    disposition: WIRE
    target_slot_heir_id: imo-creator.mission-control.system.processes
    rationale: |
      UT-Body doctrine artifact for PROC-301 Page Parser. Surfaced via the
  ...
  - artifact: factory/outreach/301-page-parser/workflow.yaml
    disposition: WIRE
    target_slot_heir_id: imo-creator.mission-control.system.processes
    rationale: |
