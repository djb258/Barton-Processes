...
outside:
  heir:
    sovereign_ref: barton-processes
    hub_id: bar-810-conform-wire
    ctb_placement: leaf
    ctb_node: barton-enterprises/svg-agency/client/810-client-intake/bars/conform-wire
    imo_topology: hub
    cc_layer: CC-01
...
inside:
  heir:
    process_id: bar.810-conform-wire
    species: Plan-Body
    version: "1.0.0"
    last_modified: "2026-05-06"
    companion_manifest: docs/plans/BAR-810-CONFORM-WIRE/PLAN-BOOK.md
  orbt:
    library_state: BUILD
---

# PLAN BOOK — BAR-810-CONFORM-WIRE

## §1 Purpose

Bring `factory/client/810-client-intake/` to Atlas/BS Law Y-junction conformance and
wire its paired Library Books (PROCESS-UT.md + workflow.yaml) into Mission Control
via the `system.processes` shelf slot.

Process: **Client Intake** (PROC-810)
...
mission_control_wiring:
  - artifact: factory/client/810-client-intake/PROCESS-UT.md
    disposition: WIRE
    target_slot_heir_id: imo-creator.mission-control.system.processes
    rationale: |
      UT-Body doctrine artifact for PROC-810 Client Intake. Surfaced via the
  ...
  - artifact: factory/client/810-client-intake/workflow.yaml
    disposition: WIRE
    target_slot_heir_id: imo-creator.mission-control.system.processes
    rationale: |
