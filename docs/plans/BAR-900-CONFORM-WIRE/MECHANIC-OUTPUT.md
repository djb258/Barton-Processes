...
# MECHANIC OUTPUT — BAR-900-CONFORM-WIRE

## Task
Conform `factory/sales/900-sales-portal` to BS Law Y-junction structure using `010-seed-d1` as the passing reference template.
...
### 1. `Barton-Processes/factory/sales/900-sales-portal/workflow.yaml`
...
- Set `inside.heir.companion_manifest: Barton-Processes/factory/sales/900-sales-portal/PROCESS-UT.md` (G11 parity field)
...
- Updated `last_transition_reason` to reference BAR-900-CONFORM-WIRE
- Preserved all original semantic content (sales portal gates, services, acceptance_criteria, determinism_gate)

### 2. `Barton-Processes/factory/sales/900-sales-portal/PROCESS-UT.md`
**Action:** Added YAML frontmatter + confirmed `## §N` section header format.
...
- Added YAML frontmatter block (`---` delimiters) at top of file with:
  ...
  - `inside.heir.companion_manifest: Barton-Processes/factory/sales/900-sales-portal/PROCESS-UT.md` (self-reference, G11 critical field)
- Section headers confirmed in `## §N` format (§1 through §14); Rung-1 regex satisfied
...
| outside.heir.hub_id | 900-sales-portal | 900-sales-portal |
| outside.heir.ctb_placement | leaf | leaf |
| outside.heir.imo_topology | hub | hub |
...
| inside.heir.process_id | bp.900 | bp.900 |
| inside.heir.version | "1.0.0" | "1.0.0" |
| inside.heir.companion_manifest | Barton-Processes/factory/sales/900-sales-portal/PROCESS-UT.md | Barton-Processes/factory/sales/900-sales-portal/PROCESS-UT.md |
...
- The `## §N` section header format was already in place in PROCESS-UT.md — no header renames required
