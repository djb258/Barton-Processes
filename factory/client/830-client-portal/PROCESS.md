...
| Sub-Hub | client |
| CTB Position | factory/client/830-client-portal |
| ORBT | BUILD |
| Strikes | 0 |
...
|-----------|------|-------------------|
| 11-structured-data | Cloudflare D1 | Shared D1 with 810 -- all page data reads + agent ticket writes |
| 06-api-layer | Hono (SSR) | Server-side HTML rendering, slug-based routing |
...
|------|----------------|-----------|-------------|-------------|
| Cloudflare D1 | 11-structured-data | Free | D1 binding | All page data reads + agent ticket writes |
