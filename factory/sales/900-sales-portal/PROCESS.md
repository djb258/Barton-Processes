...
| Field | Value |
|-------|-------|
| Blueprint | (no OSAM yet -- sales sub-hub OSAM not created) |
| OSAM Section | N/A -- pending creation |
...
|-----------|------|-------------------|
| 11-structured-data | Cloudflare D1 | All sales working tables: state, snapshots, factfinder, insurance, systems, quotes |
| 06-api-layer | Hono (SSR) | Server-side HTML rendering, slug-based routing for 4 meeting pages |
...
|------|----------------|-----------|-------------|-------------|
| Cloudflare D1 | 11-structured-data | Free | D1 binding | All sales working tables |
| Hono (CF Worker SSR) | 06-api-layer | Free | none | Server-side HTML rendering, slug-based routing |
| Neon PostgreSQL | (vault vendor) | Cheap | NEON_URL (Doppler) | Read-only source for outreach snapshot seeding |
...
|--------|------|----------|-----------|-------|
| Meeting pages rendered | count | BASELINE | — | Total HTML pages served across all 4 meetings |
| Factfinder saves | count | BASELINE | — | Successful POST /sales/:slug/meeting1/save completions |
| Phase progressions | count | BASELINE | — | sales_state.current_phase transitions |
| Snapshot seeds | count | BASELINE | — | outreach_snapshot records created from Neon |
| Slug resolution time | ms | BASELINE | — | Average D1 query time for slug -> sales_id |

### Tool Scorecard

| Tool | Expected | Actual | Status |
|------|----------|--------|--------|
| D1 (sales-portal-900) | Available | BASELINE | — |
| Neon (outreach vault) | Available | BASELINE | — |
