...
| CTB Position | factory/svg-agency/100-lcs-pipeline |
| ORBT | OPERATE |
| Strikes | 0 |
...
|------|------|-----------|-------------|-------------|
| Mailgun | API | Cheap | MAILGUN_API_KEY (Doppler) | Email delivery — 14 sending domains, rotation |
| HeyReach | API | Cheap | HEYREACH_API_KEY (Doppler) | LinkedIn outreach delivery |
| CF Queue | Native | Free | Auto | lcs-pipeline (producer+consumer) + lcs-dlq (dead letter) |
