...
| CTB Position | factory/svg-agency/820-vendor-export |
| ORBT | BUILD |
| Strikes | 0 |
...
|------|------|-----------|-------------|-------------|
| CF Worker cron | Tool | Free | none | Triggers daily export runs |
| KV (vendor-export-820) | Tool | Free | none | Stores vendor blueprint JSON mappings |
| D1 | Tool | Free | none | All data reads and audit writes |
