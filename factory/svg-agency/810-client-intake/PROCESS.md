...
| CTB Position | factory/svg-agency/810-client-intake |
| ORBT | BUILD |
| Strikes | 0 |
...
|------|------|-----------|-------------|-------------|
| Zod | Library | Free | none | Schema validation at boundary — 8 schemas for 8 table types |
| @neondatabase/serverless | Library | Free | NEON_URL | Vault promotion — D1 canonical rows to Neon clnt.* |
