...
| CTB Position | factory/svg-agency/800-client-mint |
| ORBT | BUILD |
| Strikes | 0 |
...
|------|------|-----------|-------------|-------------|
| Cloudflare Workers | Runtime | Free | none | Hosts the worker |
| Neon PostgreSQL | Database | Cheap | NEON_URL | Vault reads and promotion writes |
| D1 | Database | Free | binding | Working data for minted clients |
