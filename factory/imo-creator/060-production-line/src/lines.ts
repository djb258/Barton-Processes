...
export const LINES: Record<string, LineDef> = {
  outreach: {
    ...
    stations: [
      ...
      { id: '301-page-parser', name: 'Management Page Parser', process_id: 'PROC-301', phase: 'enrichment', depends_on: ['300-recon'], adapter_type: 'cli', adapter_target: 'python3 factory/outreach/301-page-parser/src/page-parser.py', runtime: 'Python script', orbt: 'BUILD' },
      { id: '200-people', name: 'Find Person', process_id: 'PROC-200', phase: 'enrichment', depends_on: ['301-page-parser'], adapter_type: 'cli', adapter_target: 'python3 factory/outreach/200-people-worker/src/find-person-v3.py', runtime: 'Python script', orbt: 'BUILD' },
